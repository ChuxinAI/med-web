...
export const mockDiseases: Disease[] = [
  {
    id: 'DIS-1001',
    name: '偏头痛',
    symptoms: '反复头痛、乏力，情绪波动时加重；可结合舌脉辨证。',
    formula: '天麻钩藤饮',
    note: '注意排除继发性头痛。',
    createdAt: '2024-12-18T02:20:00Z',
    updatedAt: '2024-12-18T02:20:00Z',
  },
  {
    id: 'DIS-1002',
    name: '焦虑相关躯体症状',
    symptoms: '夜间盗汗、易怒、口苦；结合情志与睡眠情况评估。',
    formula: '龙胆泻肝汤（加减）',
    note: '建议配合情志调护。',
    createdAt: '2024-12-20T06:10:00Z',
    updatedAt: '2024-12-22T09:00:00Z',
  },
  {
    id: 'DIS-1003',
    name: '慢性咳嗽',
    symptoms: '干咳少痰、午后潮热；结合病程与舌脉辨别虚实。',
    formula: '沙参麦冬汤',
    note: '注意既往呼吸系统病史。',
    createdAt: '2024-12-26T03:40:00Z',
